...
function gettingReady(){
    idH2.innerHTML = "<input type='textbox' class='textbox' value='' placeholder='Найзийн код' id='idFriendCode'>"
    idH2.innerHTML += "<br><br>"
    idH2.innerHTML += "<input type='button' class='customButtons' id='idBtn1' value = 'шалгах' onClick ='getIntoFriend()'><br><br>"
    idH2.innerHTML += "<input type='button' class='customButton' id='idBtn2' value = 'хэрхэн ашиглах вэ?' onClick ='information()'><br>"
}
...
function getIntoFriend(){
    ...
    //Oyuka egch
     ...
     //Hosoo
     else if(idFriendCode.value == "nz09hr24by"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>Hosbayr<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>Butku naiz gs hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Mni duunii sonirholiig solisond bylla hs hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n4 + "</wonky> <br>Mongol ym bhda ymarch nariihan ym dee hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n5 + "</wonky> <br>ML deer nadaas bolj hojigddog uyuded uuchil hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n6 + "</wonky> <br>Guuh hhah<br><br>"
        idH2.innerHTML +="<wonky>" + n7 + "</wonky> <br>Uhaalag, Butku, MLchin<br><br>"
        idH2.innerHTML += "<button class='customButtons1' onClick='myFeedBack()'>Nadaa heleh ug baival dar</button><br><br>"
        idH2.innerHTML += "<button onClick='back()'>butsah</button>"
    }
    ...
    else if(idFriendCode.value == "0000000000"){
        // document.body.style.textAlign = "left"
        idH2.innerHTML = "<wonky>" + n1 + "</wonky> <br>No One<br><br>"
        idH2.innerHTML +="<wonky>" + n2 + "</wonky> <br>IDK<br><br>"
        idH2.innerHTML +="<wonky>" + n3 + "</wonky> <br>Nothing to say<br><br>"
...
function zurh(){
    window.open("https://www.youtube.com/watch?v=5u4xTa3LR2U")
}
